...
Currently, the Seamless governance system only allows voting with SEAM and esSEAM tokens. This proposal aims to upgrade the Seamless governor contracts to enable stkSEAM as a votable token for governance. This upgrade must be initiated through the Seamless long governor since it involves a fundamental change to the governance structure.
