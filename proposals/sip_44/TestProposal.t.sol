...
contract TestProposal is GovTestHelper {
        ...
        public
    {
        ...
        assertEq(
            guardianBalanceAfter, guardianBalanceBefore + (2_000_000 * 1e18)
        );
        assertEq(
            timelockBalanceAfter,
            timelockBalanceBefore + expectedEmissionClaimAmount1
                + expectedEmissionClaimAmount2 - (2_000_000 * 1e18)
        );
        assertEq(
