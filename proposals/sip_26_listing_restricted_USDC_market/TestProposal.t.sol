...
contract TestProposal is Test, GovTestHelper {
    ...
    function test_checkReserveConfiguration_afterPassingProposal() public {
      ...
      (
        ...
        bool isActive,
        bool isFrozen
      ) = poolDataProvider.getReserveConfigurationData(SeamlessAddressBook.SEAMLESS_RESERVED_USDC);
      ...
      (uint256 borrowCap, uint256 supplyCap) 
        = poolDataProvider.getReserveCaps(SeamlessAddressBook.SEAMLESS_RESERVED_USDC);
